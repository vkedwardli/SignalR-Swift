...
final public class SignalRMessage : GeneratedMessage {
    ...
    override class public func fromJSON(data:Data) throws -> SignalRMessage {
        return try SignalRMessage.Builder.fromJSONToBuilder(data:data).build()
    }
    ...
    final public class Builder : GeneratedMessageBuilder {
        ...
        override class public func fromJSONToBuilder(data:Data) throws -> SignalRMessage.Builder {
